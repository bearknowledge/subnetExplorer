...
<span className="flex flex-col rounded-lg shadow shadow-xl p-7  border-b-[7px] border-t-[7px] border-[#05e69f] mobile:w-full mobile:h-[320px] laptop:w-1/2 laptop:h-[550px] laptop:mb-10 laptop:mr-4">
...
<span className="flex flex-col border-t-[7px] border-b-[7px] border-[#05e69f] rounded-lg shadow shadow-xl p-7 mobile:w-full mobile:h-[330px] mobile:my-10 laptop:w-1/2 laptop:mt-0 laptop:h-[550px]">
